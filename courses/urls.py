...
urlpatterns = patterns('courses.views',
                       ...
                       url('^assignment/(?P<pk>\d+)/edit/$', login_required(EditAssignment.as_view()), name = 'edit_assignment'),
                       ...
                       url('^resources/(?P<pk>\d+)/details/$', login_required(ResourceDetails.as_view()), name = 'resource_details'),
                       url('^resources/(?P<pk>\d+)/edit/$', login_required(EditResource.as_view()), name = 'edit_resource'),
