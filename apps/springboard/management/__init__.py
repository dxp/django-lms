...
from springboard import models
...
def create_springboard_items(sender, **kwargs):
    ...
    if models.IntranetApplication in kwargs['created_models']:
        ...
        application, created = IntranetApplication.get_or_create(url = '/admin', title='Admin')
        if created:
            application.save()
        ...
        application, created = IntranetApplication.get_or_create(url = '/courses', title='Courses')
        if created:
            application.save()
